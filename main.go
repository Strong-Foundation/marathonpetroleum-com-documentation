...
func main() {
	...
	remoteURL := "https://www.marathonpetroleum.com/Operations/Retail/Safety-Data-Sheets/"
	// The location of the local file to save the scraped data
	localFilePath := "marathonpetroleum.html"
	// The user agent.
	...
	for _, urls := range extractedPDFUrls {
		if !isUrlValid(urls) {
			urls = "https://www.marathonpetroleum.com/" + urls
		}
